...
CREATE INDEX "IX_app_log_level_logged_at" ON public.app_log (level, logged_at);


CREATE INDEX "IX_app_log_logged_at" ON public.app_log (logged_at);


CREATE INDEX "IX_app_log_transaction_id" ON public.app_log (transaction_id);
